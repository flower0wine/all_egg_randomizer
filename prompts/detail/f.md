...
- 阅读生成的相关的逻辑，现在生成的生物需要包含闪电苦力怕、骆驼僵尸骑士（拿长矛）、骆驼小僵尸骑士（拿长矛）、僵尸骆驼僵尸骑士（拿长矛）、僵尸骆驼小僵尸骑士（拿长矛）、驴、羊、骷髅、小快乐恶魂、蝌蚪、热带鱼、铁傀儡、雪傀儡、铜傀儡、流浪者、骷髅马上面骑着骷髅（拿铁剑随机附魔）、骷髅马上面骑着骷髅（拿弓随机附魔）。
- 目前除了附魔功能没有实现，其他的均已完成，当然你可以核查一遍。使用搜索工具来研究附魔相关的实现。
...
- 附魔功能在 1.21.6 发生了巨大变动，在修改之前，请你深入研究附魔功能的实现，否则你可能会遇到 API 不存在的问题。
